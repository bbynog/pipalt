    ...
    },
    {
      title: (
        <TitleWithSort
          ...
          ascending={
            order === SortOrder.Asc &&
            column === QueryCouponsOrderByColumn.MinimumCartAmount
          }
          isActive={column === QueryCouponsOrderByColumn.MinimumCartAmount}
        />
      ),
      className: 'cursor-pointer',
      ...
      width: 150,
      onHeaderCell: () =>
        onHeaderClick(QueryCouponsOrderByColumn.MinimumCartAmount),
