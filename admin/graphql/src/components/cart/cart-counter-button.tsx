...
const CartCounterButton = () => {
  ...
  return (
    <button
      className='product-cart shadow-900 fixed top-1/2 z-40 -mt-12 flex flex-col items-center justify-center rounded bg-accent p-3 pt-3.5 text-sm font-semibold text-light transition-colors duration-200 end-0 rounded-te-none rounded-be-none hover:bg-accent-hover focus:outline-none'
